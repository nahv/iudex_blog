...
/* ════════════════════════════════════════════════════════════════════
   CINEMATIC SURFACE — motion for the cinematic landing + Nexus.
   Runs as a self-contained IIFE; no-op on pages that lack the
   `body.cinematic` markup so it stays inert elsewhere.
   ════════════════════════════════════════════════════════════════════ */
